	...
	<section class="h-100">
		<div class="h-100">
			<div class="row justify-content-md-center h-100">
				<div class="col-7">
					<img src="img/bg1.jpg" alt="" style="width: 100%; height: 100vh; object-fit: cover;">
				</div>
				<div class="col-5" style="padding: 60px 90px 0;">
						<div class="pb-4 text-center">
							<img src="img/ARIMAAA.png" alt="logo" style="width: 100px;">
						</div>
						<div class="card fat";>
							<div class="card-body">
								<?php
								...
								?>
								<h3 class="card-title" style="font-weight: bold; text-align: center;">LOGIN</h3>
